...
<body class="container-fluid">
	<div id="block_form" class="form-group">
		<form action="ajoutVetExe.php" method="post">
			<table>
				<tr>
					<td><label for="name">Nom du vêtement :</label></td>
					<td><input type="text" name="name" autofocus required /></td>
				</tr>

				<tr>
					<td><label for="price">Prix du vêtement :</label></td>
					<td><input type="text" name="price" required /></td>
				</tr>

				<tr>
					<td><label for="shape">État du vêtement :</label></td>
					<td><input type="text" name="shape" required /></td>
				</tr>

				<tr>
					<td><label for="description">Description du vêtement :</label></td>
					<td><input type="text" name="description" required /></td>
				</tr>

				<tr>
					<td><label for="videoLink">Lien vidéo du vêtement :</label></td>
